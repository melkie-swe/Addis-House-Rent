<footer>
    <section id="footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h4 class="head"> <u>Contact Us</u> </h4>
                    <p> <i class="fas fa-map-marker-alt"></i> 6 Kilo ,Addis Ababa Ethio</p>
                    <p><i class="fas fa-phone"></i> +251-97-429-9472</p>
                    <p><i class="fas fa-envelope"></i> contact@addisrent.com</p>
                </div>
                <div class="col-md-4">
        ...
        <p class="text-center pb-2 mb-0"> &copy;Addis House Rent - All Rights Reserved<b></b></p>

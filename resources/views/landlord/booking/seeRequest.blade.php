            ...
            <div class="col-md-12">
                ...
                <div class="card my-5 mx-4">
                    <div class="card-header">
                        <h3 class="card-title float-left"><strong>Maintenance Requests ({{ $requests->count() }})</strong>
                        </h3>
                    ...
                    @else
                        <h2 class="text-center text-info font-weight-bold m-3">No Maintenance Request Found</h2>
                    @endif

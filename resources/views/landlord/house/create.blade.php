                ...
                <div class="card mt-5">
                    ...
                    <form action="{{ route('landlord.house.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="number_of_parking" id="number_of_parking" name="number_of_parking" value="{{ old('property_type_id') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="property_type" class="form-control" id="property_type">
                                    ...
                                    <option value="{{ $property_typ->id }}"  {{ old('property_type') == $property_typ->id ? 'selected' : '' }} >{{ $property_typ->name }}</option>
                                    @endforeach
                                </select>
                              </div>

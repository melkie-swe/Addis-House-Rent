...
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">If you're looking for hundreds more restructuring questions - or want a more fulsome
                        ...
                        is, what the deliverables look like, etc. .</p>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title " style="color: rgb(27, 154, 222)">About Our Company</h2>
                    <p class="card-text">If you're looking for hundreds more restructuring questions - or want a more
                        fulsome understanding of what restructuring really is in practice - be sure to check out the
                        Restructuring Interviews course.
